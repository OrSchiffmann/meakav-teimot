  ...
  return (
    <>
      ...
      <Section title="🩸 ברזל — הדבר הכי חשוב תזונתית">
        <p style={p}>מאגרי הברזל מהלידה מתדלדלים סביב גיל 6 חודשים. התכנית כוללת את מקורות הברזל החשובים: <b>חלמון ביצה (שבוע 2), עדשים (שבוע 3), עוף (שבוע 4), בשר בקר (שבוע 5), טחינה (שבוע 6)</b>. טיפ: ויטמין C (עגבניה, פלפל, תפוז) משפר ספיגת ברזל — שווה לשלב באותה ארוחה. אחרי ההיכרות, כדאי להגיש מזון עשיר בברזל כמעט כל יום.</p>
      </Section>
