...
export const WEEK_COMBOS: Record<number, string[]> = {
  ...
  3: ['🥬🥕 כרובית + גזר — הגזר ממתיק', '🥛🍑 יוגורט + אפרסק — קינוח ראשון', '🥦🍎 ברוקולי + תפוח — מסווה את המרירות'],
  4: ['🌾🍑 דייסת שיבולת שועל + משמש — ארוחת בוקר מנצחת', '🍚🥕 דייסת אורז + גזר — סמיך ומזין', '🥜🍎 חמאת בוטנים מדוללת + תפוח — יום האלרגן טעים יותר'],
  5: ['🟢🥒 אפונה + קישוא — ירוק ועדין', '🍠🍎 סלק + תפוח — ורוד ומתוק', '🌰🍐 חמאת שקדים + אגס — משדרג את יום האלרגן'],
