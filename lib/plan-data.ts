...
export const WEEKS: WeekPlan[] = [
  {
    ...
    tip: 'כפית אחת-שתיים מספיקות בהתחלה. התינוקת קובעת כמה — אם מסובבת ראש או סוגרת פה, מפסיקים. חלב אם/פורמולה נשארים המזון העיקרי.',
  },
  {
  ...
  },
  {
    ...
    days: [
      ...
      { food: 'עדשים כתומות', emoji: '🍲', type: 'repeat' },
    ],
  ...
  },
  {
    ...
    days: [
      ...
      { food: null, emoji: null, type: 'allergen' },
      { food: 'עוף מבושל מרוסק', emoji: '🍗', type: 'new' },
      { food: 'עוף מרוסק', emoji: '🍗', type: 'repeat' },
  ...
  },
  {
    ...
    days: [
      ...
      { food: 'בשר בקר מרוסק', emoji: '🥩', type: 'repeat' },
    ],
